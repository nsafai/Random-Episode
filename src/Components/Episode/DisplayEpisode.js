          ...
          for (let s = 0; s < epsPerSeason.length; s += 1) {
            for (let e = 0; e < epsPerSeason[s]; e += 1) {
              ...
              if (epAccumulator === 0) {
                ...
                let randomEpData = { season: s + 1, episode: e + 1, url: randomEpUrl }
                ...
                const epQuery = `https://api.themoviedb.org/3/tv/${this.movieDbId}/season/${s + 1}/episode/${e + 1}?api_key=${MOVIEDB_API_KEY}&language=en-US`;
